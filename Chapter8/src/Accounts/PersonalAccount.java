...
Purpose:an personal Account that extends account to add more specifc aspects of a personal account
...
public class PersonalAccount extends Account {
	...
	public void withdrawal(double amtount) {
		...
		if (super.getBalance()< 100) { //checking the ballance after the amount has been withdrawn and if its lower then 500 make them PAY
